...
func (h *Handler) processTrace(ctx context.Context, body io.Reader, ta trace2.TimeAnchor, meta TraceMetadata) error {
	...
	for {
		ev, err := traceparser.ParseEvent(buf, ta, trace2.CurrentVersion)
		if err == io.EOF {
			break
		}
		if err != nil {
